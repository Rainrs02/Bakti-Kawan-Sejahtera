...
export const SERVICES: ServiceData[] = [
  ...
  },
  {
    ...
    serviceItems: [
        "Ranjang Besi Tingkat (Bunk Bed)",
        "Ranjang Besi Single / Double",
        "Lemari Pakaian Plat Besi",
        "Lemari Dapur / Kitchen Set Logam",
        "Rak Sepatu Besi",
        "Rak Penyimpanan Serbaguna Logam",
        "Meja Belajar / Meja Kerja Rangka Besi",
        "Kursi Besi Teras / Kursi Taman",
        "Loker Besi Asrama",
        "Meja Makan Rangka Besi"
    ],
