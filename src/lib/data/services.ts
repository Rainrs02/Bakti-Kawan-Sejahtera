...
export const SERVICES: ServiceData[] = [
  // --- ALAT KESEHATAN ---
  {
    ...
    benefits: [
      ...
      'Garansi 3 bulan konstruksi, 1 bln sparepart',
    ],
    ...
    metaTitle: 'Service Bed Pasien Profesional | Asih Kawan Service',
    metaDescription: 'Jasa perbaikan bed pasien manual dan elektrik. Ganti spare part, perbaikan motor, dan pengecatan ulang. Garansi 3 bulan konstruksi, 1 bln sparepart.',
  ...
  },
  {
    ...
    metaTitle: 'Service Furniture Ambulance | Asih Kawan Service',
    metaDescription: 'Layanan service interior karoseri ambulance: tandu, bracket, kabinet medis. Teknisi berpengalaman. Garansi 3 bulan konstruksi, 1 bln sparepart.',
  ...
  },
  {
    ...
    metaTitle: 'Service Meja Operasi | Asih Kawan Service',
    metaDescription: 'Service dan perbaikan meja operasi: hidrolik, elektrik, matras. teknisi berpengalaman. Garansi 3 bulan konstruksi, 1 bln sparepart.',
  ...
  },
  {
    ...
    metaTitle: 'Service Troli Alkes & Emergency | Asih Kawan Service',
  ...
  },
  {
    ...
    metaTitle: 'Service Lemari Alkes & Obat | Asih Kawan Service',
    metaDescription: 'Perbaikan pintu, kunci, rak lemari alat kesehatan, medicine cabinet. Garansi 3 bulan konstruksi, 1 bln sparepart.',
  ...
  },
  {
    ...
    metaTitle: 'Service Lampu RS & Operasi | Asih Kawan Service',
    metaDescription: 'Service lampu pemeriksaan, lengan lampu turun, kelistrikan lampu OK. Garansi 3 bulan konstruksi, 1 bln sparepart.',
  ...
  // --- FURNITURE KANTOR ---
  {
    ...
    metaTitle: 'Service Sofa & Kursi Kantor Jakarta | Asih Kawan Service',
    metaDescription: 'Ganti kulit sofa, perbaikan hidrolik kursi kantor, roda macet. Hemat biaya, hasil rapi. Garansi 3 bulan konstruksi, 1 bln sparepart.',
  ...
  },
  {
    ...
    metaTitle: 'Service Lemari Arsip & Filing Cabinet | Asih Kawan Service',
    metaDescription: 'Perbaikan laci macet, kunci patah, rel filing cabinet besi dan kayu. Garansi 3 bulan konstruksi, 1 bln sparepart.',
  ...
  },
  {
    ...
    metaTitle: 'Service Meja Meeting & Resepsionis | Asih Kawan Service',
    metaDescription: 'Restorasi HPL, perbaikan meja goyang, refinishing meja meeting dan reception desk. Garansi 3 bulan konstruksi, 1 bln sparepart.',
  ...
  // --- FURNITURE KOMERSIAL ---
  {
    ...
    process: DEFAULT_PROCESS,
    faqs: [
      { question: 'Apakah ada layanan konsultasi 24 jam?', answer: 'Tentu. Kami menyediakan layanan konsultasi online 24 jam via WhatsApp untuk membantu Anda menganalisa kerusakan lebih awal.' },
    ],
    gallery: [],
    relatedSlugs: ['service-hotel', 'service-furniture-rumah-besi'],
    metaTitle: 'Service Furniture Restoran & Cafe | Asih Kawan Service',
    metaDescription: 'Reupholstery sofa booth cafe, perbaikan kursi makan. Bahan tahan air, konsultasi 24 jam. Garansi 3 bulan konstruksi, 1 bln sparepart.',
  ...
  },
  {
    ...
    metaTitle: 'Service Furniture Hotel & Trolley | Asih Kawan Service',
  ...
  },
  {
    ...
    metaTitle: 'Service Furniture Rumah Logam & Kayu | Asih Kawan Service',
...
export const CATEGORY_PAGES_DATA: CategoryPageData[] = [
  {
    ...
    longDescription: 'Divisi khusus alat kesehatan PT Asih Kawan Service didedikasikan untuk memastikan seluruh furniture dan penunjang operasional medis di rumah sakit, klinik, puskesmas, dan laboratorium Anda selalu dalam kondisi prima. Kami memahami standar tinggi yang diperlukan di lingkungan medis, mulai dari tingkat sterilisasi permukaan, anti-korosi bahan stainless steel, hingga keandalan sistem gerak actuators dan hydraulics. Didukung oleh teknisi berpengalaman dan berpengalaman 10+ tahun, kami siap melakukan diagnosis akurat dan perbaikan cepat di lokasi (on-site) maupun penanganan khusus di workshop kami.',
    image: '/images/services/troli-emergency-cat.webp',
    imageAlt: 'Troli emergency medis dan alat kesehatan rumah sakit',
    metaTitle: 'Jasa Service & Perbaikan Alat Kesehatan RS | Asih Kawan Service',
    metaDescription: 'Layanan service furniture alat kesehatan & ranjang rumah sakit. Perbaikan bed pasien manual/elektrik, meja operasi, troli emergency. Garansi 3 bulan konstruksi, 1 bln sparepart.',
  ...
  },
  {
    ...
    longDescription: 'Tampilan visual furniture adalah faktor penentu dalam bisnis kuliner dan hospitality. Sofa cafe yang sobek atau dipan hotel yang bergoyang dapat merusak kenyamanan pelanggan dan citra bisnis Anda. PT Asih Kawan Service menawarkan jasa service dan reupholstery furniture komersial dengan kualitas jahitan kelas butik dan material tahan noda. Kami menyediakan layanan konsultasi online 24 jam untuk mempercepat analisis kerusakan sehingga proses pengerjaan dapat dijadwalkan dengan presisi.',
    image: '/images/gallery/cafe/Foto Cafe (9).webp',
    imageAlt: 'Booth seating sofa kulit cokelat elegan di cafe modern',
    metaTitle: 'Jasa Service & Reupholstery Furniture Cafe, Resto, Hotel | AKS',
    metaDescription: 'Reparasi dan reupholstery sofa booth cafe, kursi makan restoran, bedset kamar hotel. Kain tahan air/noda, pengerjaan cepat (konsultasi 24 jam). Garansi 3 bulan konstruksi, 1 bln sparepart.',
