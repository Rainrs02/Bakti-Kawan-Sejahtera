...
export const SERVICES: ServiceData[] = [
  ...
  // =============================================
  {
    ...
    longDescription: `Ranjang pasien (bed pasien) merupakan aset vital di setiap fasilitas kesehatan. Kerusakan pada bed pasien dapat mengganggu kenyamanan dan keselamatan pasien, serta menghambat kinerja tenaga medis. PT Bakti Kawan Sejahtera hadir sebagai partner terpercaya untuk jasa service bed pasien secara profesional di Jabodetabek dan seluruh Indonesia.
...
Dengan dukungan teknisi berpengalaman di bidang karoseri dan interior kendaraan medis, kami memastikan setiap modifikasi dan perbaikan memenuhi regulasi dinas kesehatan. Kami siap melakukan pekerjaan on-site di pool ambulance atau rumah sakit Anda untuk meminimalisir downtime operasional unit rescue.`,
    ...
    metaTitle: 'Service Furniture Ambulance Profesional | Bakti Kawan Sejahtera',
...

  {
    ...
    longDescription: `Meja operasi (operating table/surgical table) adalah perangkat dengan tingkat kerumitan mekanis dan hidrolik yang tinggi. Kerusakan kecil pada sistem penyesuaian sudut (tilt, lateral, trendelenburg) dapat sangat fatal saat tindakan bedah berlangsung. PT Bakti Kawan Sejahtera menghadirkan teknisi spesialis yang terlatih untuk melakukan diagnosa mendalam dan perbaikan meja operasi kamar bedah.
...
Kami melayani perbaikan untuk berbagai merek meja operasi terkemuka (seperti Maquet, Trumpf, Merivaara, Mizuho, dll). Seluruh pengerjaan diakhiri dengan proses kalibrasi ketat untuk memastikan akurasi posisi sesuai indikator derajat panel kontrol.`,
    ...
    metaTitle: 'Service Meja Operasi Profesional | Bakti Kawan Sejahtera Jakarta',
...

  {
    ...
    longDescription: `Meja periksa pasien (examination table) yang robek, kotor, atau tidak stabil rangkanya dapat mengurangi rasa nyaman pasien serta merusak citra profesional klinik atau rumah sakit Anda. PT Bakti Kawan Sejahtera memberikan solusi cepat untuk service dan refurbishment meja periksa, meja tindakan, serta obgyn bed (meja ginekologi).
...
Kami memahami urgensi alat ini, sehingga kami menawarkan waktu respons kilat dan estimasi pengerjaan penjadwalan cepat untuk perbaikan ringan di wilayah Jabodetabek.`,
    ...
    metaTitle: 'Service Troli Emergency & Crash Cart | Bakti Kawan Sejahtera',
...

  {
    ...
    longDescription: `Troli instrumen medis yang digunakan di kamar operasi (OK) atau ruang sterilisasi (CSSD) dituntut bebas dari karat, retak, dan kotoran tersembunyi yang dapat menjadi sarang bakteri. PT Bakti Kawan Sejahtera menyediakan layanan reparasi khusus untuk troli instrumen stainless steel, mayo stand, serta bowl stand.
...
Selain itu, kami mengganti roda caster berkarat atau bising dengan roda berkualitas tinggi bersertifikasi medis yang tidak merusak lantai epoxy rumah sakit.`,
    ...
    metaTitle: 'Service Troli Instrumen Medis | Bakti Kawan Sejahtera Jakarta',
...

  {
    ...
    longDescription: `Lemari alat kesehatan (alkes) dan lemari obat merupakan tempat penyimpanan krusial yang memerlukan standar keamanan dan higienitas tinggi. Pintu yang macet, kaca yang retak, atau kunci yang rusak dapat menghambat akses obat saat kondisi darurat atau bahkan melanggar standar akreditasi rumah sakit. PT Bakti Kawan Sejahtera menyediakan jasa perbaikan dan refurbishment lemari alkes secara tuntas.
...
Modifikasi penambahan sekat rak acrylic atau lampu LED internal juga dapat disesuaikan dengan kebutuhan ruang farmasi Anda.`,
    ...
    metaTitle: 'Service Lemari Alkes & Medicine Cabinet | Bakti Kawan Sejahtera',
...
Kami menawarkan waktu kerja fleksibel (termasuk pengerjaan malam hari/akhir pekan) guna memastikan tidak ada gangguan pada pelayanan pasien rawat inap rumah sakit Anda.`,
    ...
    metaTitle: 'Service & Renovasi Nurse Station | Bakti Kawan Sejahtera Jakarta',
...

  {
    ...
    longDescription: `Pencahayaan yang redup atau lengan penyeimbang (spring arm) lampu pemeriksaan yang sering merosot ke bawah sangat mengganggu konsentrasi dokter saat melakukan tindakan medis atau pemeriksaan fisik pasien. PT Bakti Kawan Sejahtera memiliki teknisi yang ahli dalam service lampu pemeriksaan (examination lamp) dan lampu operasi (minor surgical light).
...
Kami memastikan intensitas cahaya (lux) dan temperatur warna pasca-servis kembali optimal sesuai standar pemeriksaan klinis.`,
    ...
    metaTitle: 'Service Lampu Pemeriksaan Medis | Bakti Kawan Sejahtera',
...

  {
    ...
    longDescription: `Lampu fisioterapi infrared memancarkan radiasi panas yang meresap ke dalam jaringan otot untuk meredakan nyeri. Oleh karena itu, akurasi durasi timer dan kestabilan intensitas panas sangat penting agar kulit pasien tidak mengalami luka bakar (overheating). PT Bakti Kawan Sejahtera melayani jasa perbaikan lampu fisioterapi infrared berbagai model (mobile stand maupun table-top).
...
Setiap unit diuji menggunakan alat pengukur radiasi termal pasca-reparasi demi keselamatan pasien.`,
    ...
    metaTitle: 'Service Lampu Fisioterapi & Infrared | Bakti Kawan Sejahtera',
  ...
  // =============================================
  {
    ...
    longDescription: `Sofa yang lusuh, robek, atau jebol di ruang tunggu direksi atau lobi kantor dapat merusak citra profesional perusahaan di mata klien penting. Mengeluarkan anggaran untuk membeli sofa baru tentu tidak perlu jika Anda bisa merestorasinya. PT Bakti Kawan Sejahtera adalah ahli reupholstery (ganti kulit) dan reparasi sofa kantor berkualitas premium.
...
Kami menyediakan layanan jemput-antar sofa untuk wilayah Jakarta, Bogor, Depok, Tangerang, dan Bekasi.`,
    ...
    metaTitle: 'Service & Reupholstery Sofa Kantor Jakarta | Bakti Kawan Sejahtera',
...

  {
    ...
    longDescription: `Kursi kantor yang rusak seperti hidrolik bocor (kursi merosot sendiri saat diduduki), roda macet/pecah, atau sandaran tangan goyang sangat memengaruhi kenyamanan dan produktivitas staf Anda, bahkan dapat memicu nyeri punggung (ergonomic hazard). PT Bakti Kawan Sejahtera adalah solusi andalan untuk service kursi kantor di Jakarta dan sekitarnya.
...
Untuk service massal di atas 10 unit, kami menyediakan layanan on-site di kantor Anda agar aktivitas operasional perusahaan Anda tetap berjalan tanpa hambatan.`,
    ...
    metaTitle: 'Service Kursi Kantor Profesional | Bakti Kawan Sejahtera Jakarta',
...

  {
    ...
    longDescription: `Lemari arsip dan filing cabinet besi yang macet lacinya sangat menjengkelkan ketika Anda harus mencari dokumen penting dengan cepat. Masalah kunci laci filing cabinet hilang atau patah juga mengancam keamanan dokumen rahasia perusahaan. PT Bakti Kawan Sejahtera melayani jasa perbaikan lemari arsip logam maupun kayu secara profesional.
...
Kami juga melayani perbaikan sistem mekanik penggerak roda pada Mobile File (Roll O'Pack) ukuran besar.`,
    ...
    metaTitle: 'Service Lemari Arsip & Filing Cabinet | Bakti Kawan Sejahtera',
...
Kami ahli dalam perbaikan lapisan veneer kayu yang mengelupas, pemolesan ulang (polishing) melamik/polyurethane permukaan meja kayu solid agar mengkilap kembali, serta penempelan ulang bahan HPL yang copot. Kami juga melayani modifikasi modern seperti pembuatan lubang tanam dan pemasangan power outlet box (stopkontak & colokan LAN/HDMI pop-up) agar meja rapat bersih dari kabel yang berserakan.`,
    ...
    metaTitle: 'Service & Restorasi Meja Meeting | Bakti Kawan Sejahtera Jakarta',
...
Cakupan kerja kami meliputi pengeleman ulang dan penggantian lembaran HPL luar yang retak, pemolesan permukaan counter berbahan solid surface atau marmer yang kusam dan tergores, pemasangan lampu LED backlight strip dekoratif tersembunyi untuk kesan modern-futuristik, serta pembuatan laci penyimpanan rekam medis/kasir tambahan lengkap dengan sistem kunci laci yang aman.`,
    ...
    metaTitle: 'Service & Renovasi Reception Desk | Bakti Kawan Sejahtera',
    metaDescription: 'Layanan service dan renovasi reception desk lobi kantor, hotel, klinik. Restorasi, redesain modern, material premium. Garansi 12 bulan. Konsultasi gratis!',
    image: '/images/services/reception-desk.png',
  ...
  // =============================================
  {
    ...
    longDescription: `Di bisnis kuliner (F&B), kenyamanan tempat duduk berbanding lurus dengan lamanya pelanggan tinggal dan besarnya nominal pesanan mereka. Sofa cafe atau booth seating restoran yang kulitnya pecah-pecah, robek, atau busanya amblas hingga menyentuh rangka kayu akan membuat pelanggan kapok berkunjung kembali. PT Bakti Kawan Sejahtera menawarkan jasa reupholstery sofa cafe dan booth seating dengan kualitas jahitan kelas butik.
...
Kami menawarkan opsi pengerjaan malam hari saat cafe tutup untuk meminimalkan kehilangan omzet bisnis Anda.`,
    ...
    metaTitle: 'Service & Reupholstery Sofa Cafe | Bakti Kawan Sejahtera Jakarta',
    metaDescription: 'Layanan service sofa cafe, reupholstery kursi restoran. Material tahan noda, ratusan pilihan warna. Pengerjaan cepat, garansi 12 bulan. Hubungi kami!',
...

  {
    ...
    longDescription: `Penggunaan harian yang sangat intensif membuat kursi dan meja makan restoran rentan bergoyang atau patah pada sambungan kaki-kakinya. Kursi makan yang tidak kokoh sangat berbahaya karena dapat membuat pelanggan terjatuh dan memicu tuntutan hukum. PT Bakti Kawan Sejahtera menyediakan layanan perbaikan furniture restoran secara cepat dan massal.
...
Kami siap melayani jaringan restoran waralaba (restaurant chain) dengan kontrak maintenance berkala yang ekonomis.`,
    ...
    metaTitle: 'Service Furniture Restoran Profesional | Bakti Kawan Sejahtera',
...
Kami bekerja sama dengan divisi housekeeping hotel Anda untuk menjadwalkan perbaikan blok per blok kamar (room-by-room staging) agar tingkat okupansi (occupancy rate) hotel Anda tetap terjaga maksimal selama masa perbaikan.`,
    ...
    metaTitle: 'Service Furniture Hotel & Hospitality | Bakti Kawan Sejahtera',
...

  {
    ...
    longDescription: `Visual merchandising yang menarik sangat bergantung pada kondisi fisik rak display dan meja kasir toko Anda. Rak gondola yang miring karena tidak kuat menahan beban produk, atau showcase kaca dengan pintu geser macet dapat mengurangi estetika display produk dan menurunkan minat beli pengunjung showroom/butik Anda. PT Bakti Kawan Sejahtera melayani jasa perbaikan furniture retail terlengkap.
...
Kami siap dipanggil untuk pengerjaan malam hari setelah toko tutup (after-hours service) guna memastikan tidak ada gangguan pada aktivitas belanja pelanggan Anda.`,
    ...
    metaTitle: 'Service Furniture Retail & Toko | Bakti Kawan Sejahtera Jakarta',
...
export const CATEGORY_PAGES_DATA: CategoryPageData[] = [
  {
    ...
    longDescription: 'Divisi khusus alat kesehatan PT Bakti Kawan Sejahtera didedikasikan untuk memastikan seluruh furniture dan penunjang operasional medis di rumah sakit, klinik, puskesmas, dan laboratorium Anda selalu dalam kondisi prima. Kami memahami standar tinggi yang diperlukan di lingkungan medis, mulai dari tingkat sterilisasi permukaan, anti-korosi bahan stainless steel, hingga keandalan sistem gerak actuators dan hydraulics. Didukung oleh teknisi bersertifikasi dan berpengalaman 10+ tahun, kami siap melakukan diagnosis akurat dan perbaikan cepat di lokasi (on-site) maupun penanganan khusus di workshop kami.',
    image: '/images/services/bed-pasien.png',
  ...
  },
  {
    ...
    longDescription: 'Tampilan visual furniture adalah faktor penentu dalam bisnis kuliner dan hospitality. Sofa cafe yang sobek atau dipan hotel yang bergoyang dapat merusak kenyamanan pelanggan dan citra bisnis Anda. PT Bakti Kawan Sejahtera menawarkan jasa service dan reupholstery furniture komersial dengan kualitas jahitan kelas butik dan material tahan noda. Kami memahami pentingnya kelancaran usaha Anda, oleh karena itu kami menawarkan opsi waktu kerja malam hari (after-hours) agar pengerjaan tidak mengganggu omzet harian Anda.',
    image: '/images/services/sofa-cafe.png',
    ...
    metaDescription: 'Reparasi dan reupholstery sofa booth cafe, kursi makan restoran, bedset kamar hotel. Kain tahan air/noda, pengerjaan cepat (opsi malam hari). Garansi 12 bulan.',
