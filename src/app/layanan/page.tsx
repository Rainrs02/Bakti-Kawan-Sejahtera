...
export const metadata: Metadata = {
  title: 'Semua Layanan Service Furniture | Bakti Kawan Sejahtera',
  description: 'Layanan service furniture alat kesehatan, kantor, dan komersial. 19+ jenis layanan, teknisi bersertifikasi, garansi tertulis. Fast response Jabodetabek.',
}
      ...
      <div className="pt-24 pb-16 bg-bg-section">
        <div className="container-main">
          ...
          <p className="text-secondary text-xl max-w-2xl">
            Dari alat kesehatan rumah sakit hingga furniture komersial premium. Semua ditangani teknisi bersertifikasi dengan garansi tertulis.
          </p>
        </div>
      </div>
