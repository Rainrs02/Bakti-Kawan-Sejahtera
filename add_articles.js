...
Banyak pihak manajemen rumah sakit yang sering mengabaikan kondisi kursi roda karena dianggap sebagai alkes "sekunder" dibandingkan dengan perangkat berteknologi tinggi seperti mesin MRI atau ventilator. Namun, kelalaian dalam merawat kursi roda dapat memicu konsekuensi serius:
...
if (replacementIndex !== -1) {
    const newContent = content.substring(0, replacementIndex) + articles + content.substring(replacementIndex);
    fs.writeFileSync(targetPath, newContent, 'utf8');
    console.log('Successfully appended articles');
} else {
    console.log('Failed to find array closing bracket');
}
